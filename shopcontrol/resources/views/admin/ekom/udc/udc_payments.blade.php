...
@section('content')
    ...
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">UDC Payments &nbsp;&nbsp;
        <small></small>
    </h1>
    <!-- END PAGE TITLE-->
            ...
            <div class="portlet light bordered">
                <div class="portlet-title tabbable-line">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark bold uppercase">UDC Payments</span>
                    </div>
                </div>
                ...
                <div class="portlet-body">
                    ...
                    <div id="udc-list">
                        @include('admin.ekom.udc.render_udc_payments')
                    </div>
