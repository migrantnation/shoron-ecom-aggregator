...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{__('_ecom__text.udc-transactions')}}</span>
            </li>
        </ul>
    </div>
    <!-- END PAGE BAR -->
    ...
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">{{__('_ecom__text.udc-transactions')}}
        <small></small>
    </h1>
    <!-- END PAGE TITLE-->
            ...
            <div class="portlet light bordered">
                <div class="portlet-title tabbable-line">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark bold uppercase">{{__('_ecom__text.udc-transactions')}}</span>
                    </div>
                </div>
                ...
                <div class="portlet-body">
                    ...
                    <div id="udc-list">
                        @include('admin.ekom.udc.transactions.render_index_data')
                    </div>
...
//                var page = $(this).attr('href').split('page=')[1];
                $.ajax({
                    url: "{{url('admin/udc/transactions')}}",
                    type: "get",
                    dataType: 'json',
                    data: {
                    ...
                    success: function (html) {
                        ...
                        var url = "{{url('admin/udc/transactions?')}}"
                            + "search_string=" + $('#search_string').val()
                            + "&page=2"
                            + '&division=' + $('#division').val()
                            + '&district=' + $('#district').val()
