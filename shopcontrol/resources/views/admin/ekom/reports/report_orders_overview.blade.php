...
@section('content')
    ...
    <div class="row full-height">
        <div class="col-lg-12 col-xs-12 col-sm-12">
            ...
            <form class="form-inline" action="{{url('admin/reports/orders')}}">
                ...
                <div class="form-group">
                    <select name="" id="filter_range" class="form-control">
                        ...
                        <option value="week">Cancelled</option>
                        <option value="month">Warehouse Left</option>
                        <option value="year">Delivered</option>
                    </select>
                </div> &nbsp; &nbsp;
        ...
        <div id="report-render">
            @include('admin.ekom.reports.render_report_orders')
        </div>
    </div>
    <div class="clearfix"></div>
