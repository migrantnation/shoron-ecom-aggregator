        ...
        <div class="m-portlet m-portlet--bordered-semi m-portlet--half-height m-portlet--fit "
            ...
            <div class="m-portlet__body">
                <div class="text-left col-md-8" style="font-size: 14px;">
                    ...
                    <br>
                    <span class="caption-subject text-info bold uppercase">Deactivated UDC:</span>
                    <span class="text-info bold" style="padding-left:10px;"
                          id="total_deactivate">{{@$total_deactivate}}</span>
                </div>
                <div class="text-left col-md-4" style="font-size: 14px;">
                    ...
                    <br>
                    <span class="caption-subject text-info bold uppercase">Total Deactivated UDC:</span>
                    <span class="text-info bold" style="padding-left:10px;"
                          id="total_deactivate">{{@$total_deactivate_udc}}</span>
                </div>
            </div>
        </div>
            ...
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject text-primary bold uppercase">UDC Overview Chart</span>
                    </div>
                </div>
                <div class="portlet-body">
                    <canvas id="m_chart_bandwidth2" height="270"
                            data-ep-name='["UDC member on board", "Package Distributed", "Deactivate UDC"]'
                            data-labels='[{{@$chart_labels}}]'
                            data-values="[[{{@$chart_onboard_member_values}}],[{{@$chart_package_distributed_values}}],[{{@$chart_deactivate_udc_values}}]]">
        ...
        <div class="portlet-body" id="ep_orders">
            <div class="portlet light ">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-share font-red-sunglo hide"></i>
                        <span class="caption-subject text-primary bold uppercase">UDC Overview Per Day</span>
                    </div>
                </div>
                <div class="portlet-body">
                    <?php
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th width="20%" class="text-center">Deactivate UDC</th>
                        </tr>
                        </thead>
                        <tbody>
                        @forelse($chart_labels as $key=>$labels)
                            <tr>
                                ...
                                <td class="text-right">{{@$chart_deactivate_udc_values[$key]}}</td>
                            </tr>
                        @empty
                        @endforelse
                        ...
                        <tr>
                            ...
                            <td class="text-right"><strong>Total: {{@$total_deactivate}}</strong></td>
                        </tr>
                        </tbody>
                    </table>
