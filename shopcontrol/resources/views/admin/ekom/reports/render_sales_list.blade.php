...
<table class="table table-bordered table-hover">
    ...
    <tr>
        ...
        <th width="24%" class="text-center">Total Orders</th>
        <th width="24%" class="text-right">Total Sales</th>
        <th width="24%" class="text-right">Average Order Value</th>
    </tr>
    </thead>
    <tbody>
    @forelse($chart_labels as $key=>$labels)
        <tr>
            ...
            <td class="text-right">
                ৳ {{$chart_order_values[$key]? number_format(($chart_sale_values[$key]/$chart_order_values[$key]), 2):'0.00'}}
            </td>
        </tr>
    @empty
    @endforelse
