...
@section('content')
                    ...
                    <form class="form-inline" action="javascript:;">
                        <div class="form-group">
                            ...
                            <select name="ep_id" id="ep_id" class="form-control">
                                <option value="all" {{@$epId && @$epId == 'all' ? 'selected' : ''}} >All EP</option>
                                @forelse($all_eps as $ep)
                                    <option value="{{$ep->id}}" {{@$epId && @$epId == $ep->id ? 'selected' : ''}} >{{$ep->ep_name}}</option>
                                @empty
            ...
            <div class="tabbable-line boxless tabbable-reversed">
                <div class="tab-content" style="background-color: #F4F6F8" id="">
                    ...
                    <div id="disbursed_commission_list">
                        @include('admin.ekom.reports.render-disbursed-commission-list')
                    </div>
    ...
    <script>
        ...
        $(document).on('click', '.pagination a', function (e) {
            ...
            $.ajax({
                url: '{{url("admin/disburesed-commission-list")}}',
                type: "get",
                dataType: 'json',
                data: data,
    ...
    <script>
        ...
        var url = "{{url('admin/disburesed-commission-list')}}";
