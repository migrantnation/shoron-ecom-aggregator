...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('admin/customer-support-list')}}">{{__('_ecom__text.customer-support-list')}}</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>{{__('_ecom__text.customer-support-details')}}</span>
            </li>
        </ul>
    </div>
    <!-- END PAGE BAR -->
    ...
    <div class="container-alt margin-top-20">
        <a href="{{url('admin/customer-support-list')}}" class=""><small class="fa fa-angle-left"></small> &nbsp;{{__('_ecom__text.back-customer-support-list')}}</a>
        <h3 class="margin-top-10 margin-bottom-15">{{__('_ecom__text.customer-support-overview')}}</h3>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select name="group" class="form-control">
                                ...
                                <option value="3" selected>{{__('_ecom__text.customer-support')}}</option>
                            </select>
                        </div>
                    </div>
