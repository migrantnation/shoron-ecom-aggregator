...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{__('_ecom__text.super-admin-list')}}</span>
            </li>
        </ul>
    </div>
    <!-- END PAGE BAR -->
    ...
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">{{__('_ecom__text.super-admin-list')}}&nbsp;
        <small></small>
        <a href="{{url('admin/super-admin/create')}}" class="btn btn-info">{{__('_ecom__text.add-new')}}
            ...
            <div class="portlet light bordered">
                <div class="portlet-title tabbable-line">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark bold uppercase">{{__('_ecom__text.add-new')}}</span>
                    </div>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td width="180" class="text-center">
                                <a href="{{url('admin/super-admin/edit')}}" class="btn blue btn-xs">
