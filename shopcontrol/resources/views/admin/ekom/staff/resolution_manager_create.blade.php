...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{url('admin/resolution-manager-list')}}">{{__('_ecom__text.resolution-manager-list')}}</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>{{__('_ecom__text.add-new-resolution-manager')}}</span>
            </li>
        </ul>
    </div>
    <!-- END PAGE BAR -->
    ...
    <div class="container-alt margin-top-20">
        <a href="{{url('admin/resolution-manager-list')}}" class=""><small class="fa fa-angle-left"></small> &nbsp;{{__('_ecom__text.back-resolution-manager-list')}}</a>
        <h3 class="margin-top-10 margin-bottom-15">{{__('_ecom__text.add-new-resolution-manager')}}</h3>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select name="group" class="form-control">
                                ...
                                <option value="4">{{__('_ecom__text.accountant')}}</option>
                                <option value="4" selected>{{__('_ecom__text.resolution-manager')}}</option>
                            </select>
                        </div>
                    </div>
