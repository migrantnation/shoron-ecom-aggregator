...
@section('content')
    ...
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">EP Payments &nbsp;&nbsp;
        <small></small>
    </h1>
    <!-- END PAGE TITLE-->
            ...
            <div class="portlet light bordered">
                <div class="portlet-title tabbable-line">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark bold uppercase">EP Payments</span>
                    </div>
                </div>
                ...
                <div class="portlet-body">
                    ...
                    <div id="ep-list">
                        ...
                        @include('admin.ekom.ep.payment.render_ep_payments')
                    </div>
