                            ...
                            <div class="col-xs-12">
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center hidden-480">Paid Commission</th>
                                        <th class="text-center hidden-480">Due Commission</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{date('F ,Y ', strtotime($disbursed_info->disbursement_to_date))}}</td>
                                        ...
                                        <td class="text-center hidden-480">{{__('admin_text.tk.')}}{{$disbursed_info->amount}}</td>
                                        <td class="text-center hidden-480">{{__('admin_text.tk.')}}{{$disbursed_info->due_amount}}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
