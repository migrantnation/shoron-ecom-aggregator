        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    {{implode(', ', $address)}}
                    <br>
                    Package Status: <strong class="text-info">{!!@$lp_package?((@$lp_package->is_selected==1)?'Activated':'Deactivated'):'Not Assigned'!!}</strong>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    @if(!@$lp_package)
                        <a class="btn btn-primary" onclick="save_package({{$user->id}})">
                            Save
                        </a>
                    @endif
...
<script>
    ...
    function save_package(location_id){
    ...
    $(".change-status").click(function (e) {
        ...
        $('#loader' + location_id).show();
        $.ajax({
            url: "{{url("lp/change-package-status")}}",
            type: "post",
            dataType: 'json',
            data: data,
            success: function (response) {
