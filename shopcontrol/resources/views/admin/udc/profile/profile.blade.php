        ...
        <div class="left-part">
            <div class="profile-inner-block">
                <div class="profile-cover clearfix">
                    ...
                    <div class="profile-information">
                        <div class="profile-basic">
                            <div class="clearfix">
                                <h3 class="profile-name"><a href="#" target="_blank">{{@$user_info->name}}</a></h3>
                            </div>
                            <address class="p-address"><i class="fa fa-map-marker"></i>&nbsp; {{@$user_info->address}}</address>
                            <p class="meta-info">{{@$user_info->contact_number}}, <a href="mailto:info@example.com">{{@$user_info->email}}</a></p>
                        </div>
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="table-scrollable table-scrollable-borderless">
                            <table class="table table-hover table-light">
                                ...
                                <tr>
                                    <td class="fit">
                                        <img class="user-pic" src="{{url('public/admin_ui_assets')}}/global/img/portfolio/1200x900/62.jpg"> </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="fit">
                                        <img class="user-pic" src="{{url('public/admin_ui_assets')}}/global/img/portfolio/1200x900/69.jpg"> </td>
                                    <td>
                                        <a href="javascript:;" class="primary-link">Body Spray</a>
                                    </td>
                                    <td> 04-07-2017 </td>
                                ...
                                <tr>
                                    <td class="fit">
                                        <img class="user-pic" src="{{url('public/admin_ui_assets')}}/global/img/portfolio/1200x900/70.jpg"> </td>
                                    <td>
                                        <a href="javascript:;" class="primary-link">Body Spray</a>
                                    </td>
                                    <td> 04-07-2017 </td>
                                ...
                                <tr>
                                    <td class="fit">
                                        <img class="user-pic" src="{{url('public/admin_ui_assets')}}/global/img/portfolio/1200x900/95.jpg"> </td>
                                    <td>
                                        <a href="javascript:;" class="primary-link">Body Spray</a>
                                    </td>
                                    <td> 04-07-2017 </td>
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="table-scrollable table-scrollable-borderless">
                            <table class="table table-hover table-light">
                                ...
                                <tr>
                                    <td class="fit">
                                        <img class="user-pic" src="{{url('public/admin_ui_assets')}}/global/img/portfolio/1200x900/22.jpg"> </td>
                                    <td>
                                        <a href="javascript:;" class="primary-link">Body Spray</a>
                                    </td>
                                    <td> 04-07-2017 </td>
                                ...
                                <tr>
                                    <td class="fit">
                                        <img class="user-pic" src="{{url('public/admin_ui_assets')}}/global/img/portfolio/1200x900/23.jpg"> </td>
                                    <td>
                                        <a href="javascript:;" class="primary-link">Body Spray</a>
                                    </td>
                                    <td> 04-07-2017 </td>
                                ...
                                <tr>
                                    <td class="fit">
                                        <img class="user-pic" src="{{url('public/admin_ui_assets')}}/global/img/portfolio/1200x900/97.jpg"> </td>
                                    <td>
                                        <a href="javascript:;" class="primary-link">Body Spray</a>
                                    </td>
                                    <td> 04-07-2017 </td>
                                ...
                                <tr>
                                    <td class="fit">
                                        <img class="user-pic" src="{{url('public/admin_ui_assets')}}/global/img/portfolio/1200x900/77.jpg"> </td>
                                    <td>
                                        <a href="javascript:;" class="primary-link">Body Spray</a>
                                    </td>
                                    <td> 04-07-2017 </td>
                ...
                <div class="portlet light ">
                    <div class="portlet-body">
                        <div class="clearfix plx__portlet-header">
                            <a href="{{url("udc/report")}}" class="pull-right">Show More Details</a>
