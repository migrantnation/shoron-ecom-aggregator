...
@section('content')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>{{ __('admin_text.report') }}</span>
            </li>
        </ul>
    </div>
    <!-- END PAGE BAR -->
    ...
    <div class="container-alt">
        <!-- BEGIN PAGE TITLE-->
        <h1 class="page-title"> {{ __('admin_text.report') }}
            <small></small>
        </h1>
        <!-- END PAGE TITLE-->
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                ...
                <div class="portlet light ">
                    <div class="portlet-body">
                        <div class="clearfix plx__portlet-header">
                            <h3 class="plx_portlet-title">{{ __('admin_text.sales') }}</h3>
                        </div>
                ...
                <div class="portlet light ">
                    <div class="portlet-body">
                        <div class="clearfix plx__portlet-header">
                            <h3 class="plx_portlet-title">{{ __('admin_text.customers') }}</h3>
                        </div>
                ...
                <div class="portlet light ">
                    <div class="portlet-body">
                        <div class="clearfix plx__portlet-header">
                            <h3 class="plx_portlet-title">{{ __('admin_text.ecommerce-partners') }}</h3>
                        </div>
            ...
            <div class="col-md-6 col-sm-6">
                ...
                <div class="portlet light ">
                    <div class="portlet-body">
                        <div class="clearfix plx__portlet-header">
                            <h3 class="plx_portlet-title">{{ __('admin_text.purchases') }}</h3>
                        </div>
                ...
                <div class="portlet light ">
                    <div class="portlet-body">
                        <div class="clearfix plx__portlet-header">
                            <h3 class="plx_portlet-title">{{ __('admin_text.logistics') }}</h3>
                        </div>
                ...
                <div class="portlet light ">
                    <div class="portlet-body">
                        <div class="clearfix plx__portlet-header">
                            <h3 class="plx_portlet-title">{{ __('admin_text.finances') }}</h3>
                        </div>
